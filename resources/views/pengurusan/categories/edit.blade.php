...
@section('title', 'Kemaskini Kategori')

@section('content')
{!! Form::model($category, ['route' => ['pengurusan.categories.update', $category], 'method'=>'PUT','id'=>'modalFormKategori']) !!}
...
<div class="modal-body">
    @include('pengurusan.categories._form')
</div>
<!-- /.modal-body -->
