                    ...
                    <div class="row">
                        <div class="col-md-5 d-flex justify-content-center align-items-center">
                            <div class="card text-center">
                                ...
                                <p class="m-0 ml-2 text-info"><a href="{{ asset($elad->dokumen ? 'storage/uploads/elad/dokumen/' . $elad->dokumen : 'img/no-photos.png') }}" data-toggle="lightbox" data-title="{{ $elad->tajuk }}" data-gallery="gallery"><small>Klik Sini Untuk Paparan Penuh</small></a></p>
                            </div>
                        </div>                 
