...
@section('title', 'Daftar Rekabentuk Landskap')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-olive card-outline ">
                ...
                {{ Form::open(['route' => ['pengurusan.elad.store'], 'enctype' => 'multipart/form-data', 'id' => 'eladForm']) }} 
                    <div class="card-body table-hardscape form-hardscape text-sm">
                        <div class="row">
                            <!-- Left Column: Main Form -->
                            <div class="col-md-6">
                                @include('pengurusan.elad._form')
                            </div>
                ...
                <div class="card-footer">
                    {!! Form::button('Batal dan Kembali', ['onclick'=>"window.location='".route('pengurusan.elad.index')."'",'class'=>'btn btn-secondary']) !!}
