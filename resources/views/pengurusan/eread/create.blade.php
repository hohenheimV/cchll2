...
@section('title', 'Daftar Maklumat R&D Landskap ')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-olive card-outline ">
                ...
                {{ Form::open(['route' => ['pengurusan.eread.store'], 'enctype' => 'multipart/form-data', 'id' => 'ereadForm']) }} 
                    <div class="card-body table-hardscape form-hardscape text-sm">
                        <div class="row">
                            <!-- Left Column: Main Form -->
                            <div class="col-md-6">
                                @include('pengurusan.eread._form')
                            </div>
                ...
                <div class="card-footer">
                    {!! Form::button('Batal dan Kembali', ['onclick'=>"window.location='".route('pengurusan.eread.index')."'",'class'=>'btn btn-secondary']) !!}
