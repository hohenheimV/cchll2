...
@section('card-title', 'Kemaskini Maklumat Penyelenggaraan Risiko')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-olive card-outline ">
                ...
                {!! Form::model($risiko, ['route' => ['pengurusan.softscapes.risiko.update', $risiko], 'method'=>'PUT','id'=>'modalFormDaun']) !!}
