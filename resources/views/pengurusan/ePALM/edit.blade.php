...
@section('title', 'Kemaskini Maklumat Taman & Landskap')
        ...
        <div class="col-lg-12">
            <div class="card card-olive card-outline">
                ...
                <div class="card-body table-hardscape form-hardscape text-sm">
                    @if($ePALM->id_permohonan == null)
                        <style>
                            .inertClass input[name="nama_pbt"],
                            .inertClass textarea[name="nama_taman"] {
                    ...
                    @elseif($ePALM->id_permohonan != null || isset($ePALM->nama_taman))
                        <style>
                            .inertClass {
                                pointer-events: none;
                            }
