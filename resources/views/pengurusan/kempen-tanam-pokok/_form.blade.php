...
<div class="form-row">
    <div class="form-group col-md-6">
        ...
        {{ Form::text('nama_kempen', null, ['placeholder' => 'Masukkan Nama Kempen', 'class' => 'form-control' . Html::isInvalid($errors, 'nama_kempen')]) }}
...
<div class="form-row">
    <div class="form-group col-md-7">
        <div class="table-responsive">
            <table id="spesis-pokok-table" class="table table-bordered table-hover">
                <thead class="thead-dark">
                    ...
                    <tr>
                        ...
                        <th class="w-15" id="add_spesis_pokok">[Tambah Spesis]</th>
                    </tr>
                </thead>
                <tbody id="spesis_pokok_container">
                    @if(isset($spesisPokokJumlahPairs))
                        ...
                        <tr>
                            <td><input type="text" name="spesis_pokok[]" class="form-control" value="{{ $pair['spesis_pokok'] }}" placeholder="Masukkan Spesis Pokok"></td>
                            <td><input type="number" name="jumlah_pokok[]" class="form-control" value="{{ $pair['jumlah_pokok'] }}" placeholder="Masukkan Jumlah Pokok" min="1"></td>
                            <td><button type="button" class="btn btn-danger btn-sm remove_field">Hapus</button></td>
                        </tr>
                        @endforeach
                    @else
                        <tr>
                            <td><input type="text" name="spesis_pokok[]" class="form-control" placeholder="Masukkan Spesis Pokok"></td>
                            <td><input type="number" name="jumlah_pokok[]" class="form-control" placeholder="Masukkan Jumlah Pokok" min="1"></td>
                            <td><button type="button" class="btn btn-danger btn-sm remove_field">Hapus</button></td>
                        </tr>
                    @endif
                </tbody>
            ...
            <!-- <button type="button" class="btn btn-primary btn-sm mt-2" id="add_spesis_pokok">Tambah Spesis Pokok</button> -->
        </div>
