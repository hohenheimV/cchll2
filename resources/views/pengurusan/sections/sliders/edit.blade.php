...
@section('title', 'Kemaskini Sliders')

@section('content')
{!! Form::model($slider, ['route' => ['pengurusan.sliders.update', $slider], 'method'=>'PUT','id'=>'modalFormSlider']) !!}
...
<div class="modal-body">
    @include('pengurusan.sections.sliders._form')
</div>
<!-- /.modal-body -->
