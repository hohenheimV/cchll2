    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-olive card-outline ">
                ...
                @endphp
                {{ Form::open(['route' =>['pengurusan.hardscape.store'],'id'=>'modalFormMenu']) }}
                ...
                <div class="card-footer">
                    {!! Form::button('Batal dan Kembali', ['onclick'=>"window.location='".route('pengurusan.hardscape.index')."'",'class'=>'btn btn-secondary']) !!}
