                            ...
                            @foreach($MIB->kawasan as $key => $kawasan)
                                <tr>
                                    <td style="vertical-align:middle;">
                                        <input type="text" name="kawasan[{{ $key }}][nama]" class="form-control"  value="{{ $kawasan['nama'] ?? '' }}">
                                    </td>
                                    <td style="vertical-align:middle;">
                                        <input type="text" name="kawasan[{{ $key }}][keluasan]" class="form-control decimal"  value="{{ $kawasan['keluasan'] ?? '' }}">
                                    </td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
                                <td style="vertical-align:middle;">
                                    <input type="text" name="kawasan[0][nama]" class="form-control"  value="">
                                </td>
                                <td style="vertical-align:middle;">
                                    <input type="text" name="kawasan[0][keluasan]" class="form-control decimal"  value="">
                                </td>
                            </tr>
                        @endif
                    </tbody>
            ...
            <table class="table table-bordered" style="margin-bottom:0;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="pengerusi_nama" name="pengerusi_nama" class="form-control"  value="{{ isset($rakanTaman) ? $rakanTaman[0]['pengerusi_nama'] : '' }}"></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="pengerusi_tel_bimbit" name="pengerusi_tel_bimbit" class="form-control"  value="{{ isset($rakanTaman) ? $rakanTaman[0]['pengerusi_tel_bimbit'] : '' }}"></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="pengerusi_email" name="pengerusi_email" class="form-control lowercase"  value="{{ isset($rakanTaman) ? $rakanTaman[0]['pengerusi_email'] : '' }}"></td>
                    </tr>
                    @else
                    <tr>
                        <td style="padding: 4px 8px; line-height: 1;">Pengerusi <span class="font-red"> * </span></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="pengerusi_nama" name="pengerusi_nama" class="form-control"  value=""></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="pengerusi_tel_bimbit" name="pengerusi_tel_bimbit" class="form-control"  value=""></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="pengerusi_email" name="pengerusi_email" class="form-control lowercase"  value=""></td>
                    </tr>
                    @endif
                    @if(isset($rakanTaman[1]))
                    <tr>
                        <td style="padding: 4px 8px; line-height: 1;">Timbalan Pengerusi <span class="font-red"> * </span></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="timbalan_pengerusi_nama" name="timbalan_pengerusi_nama" class="form-control"  value="{{ isset($rakanTaman) ? $rakanTaman[1]['timbalan_pengerusi_nama'] : '' }}"></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="timbalan_pengerusi_tel_bimbit" name="timbalan_pengerusi_tel_bimbit" class="form-control"  value="{{ isset($rakanTaman) ? $rakanTaman[1]['timbalan_pengerusi_tel_bimbit'] : '' }}"></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="timbalan_pengerusi_email" name="timbalan_pengerusi_email" class="form-control lowercase"  value="{{ isset($rakanTaman) ? $rakanTaman[1]['timbalan_pengerusi_email'] : '' }}"></td>
                    </tr>
                    @else
                    <tr>
                        <td style="padding: 4px 8px; line-height: 1;">Timbalan Pengerusi <span class="font-red"> * </span></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="timbalan_pengerusi_nama" name="timbalan_pengerusi_nama" class="form-control"  value=""></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="timbalan_pengerusi_tel_bimbit" name="timbalan_pengerusi_tel_bimbit" class="form-control"  value=""></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="timbalan_pengerusi_email" name="timbalan_pengerusi_email" class="form-control lowercase"  value=""></td>
                    </tr>
                    @endif
                    @if(isset($rakanTaman[2]))
                    <tr>
                        <td style="padding: 4px 8px; line-height: 1;">Setiausaha <span class="font-red"> * </span></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="setiausaha_nama" name="setiausaha_nama" class="form-control "  value="{{ isset($rakanTaman) ? $rakanTaman[2]['setiausaha_nama'] : '' }}" ></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="setiausaha_tel_bimbit" name="setiausaha_tel_bimbit" class="form-control"  value="{{ isset($rakanTaman) ? $rakanTaman[2]['setiausaha_tel_bimbit'] : '' }}" ></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="setiausaha_email" name="setiausaha_email" class="form-control lowercase"  value="{{ isset($rakanTaman) ? $rakanTaman[2]['setiausaha_email'] : '' }}"></td>
                    </tr>
                    @else
                    <tr>
                        <td style="padding: 4px 8px; line-height: 1;">Setiausaha <span class="font-red"> * </span></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="setiausaha_nama" name="setiausaha_nama" class="form-control "  value="" ></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="setiausaha_tel_bimbit" name="setiausaha_tel_bimbit" class="form-control"  value="" ></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="setiausaha_email" name="setiausaha_email" class="form-control lowercase"  value=""></td>
                    </tr>
                    @endif
                    @if(isset($rakanTaman[3]))
                    <tr>
                        <td style="padding: 4px 8px; line-height: 1;">Bendahari <span class="font-red"> * </span></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="bendahari_nama" name="bendahari_nama" class="form-control "  value="{{ isset($rakanTaman) ? $rakanTaman[3]['bendahari_nama'] : '' }}" ></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="bendahari_tel_bimbit" name="bendahari_tel_bimbit" class="form-control "  value="{{ isset($rakanTaman) ? $rakanTaman[3]['bendahari_tel_bimbit'] : '' }}" ></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="bendahari_email" name="bendahari_email" class="form-control lowercase"  value="{{ isset($rakanTaman) ? $rakanTaman[3]['bendahari_email'] : '' }}"></td>
                    </tr>
                    @else
                    <tr>
                        <td style="padding: 4px 8px; line-height: 1;">Bendahari <span class="font-red"> * </span></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="bendahari_nama" name="bendahari_nama" class="form-control "  value="" ></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="bendahari_tel_bimbit" name="bendahari_tel_bimbit" class="form-control "  value="" ></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="bendahari_email" name="bendahari_email" class="form-control lowercase"  value=""></td>
                    </tr>
                    @endif
                    ...
                    @for ($i = 1; $i <= 6; $i++)
                        <tr>
                            ...
                            <td style="padding: 4px 8px; line-height: 1;">
                                <input type="text" id="ajk{{ $i }}_nama" name="ajk{{ $i }}_nama" class="form-control"  
                                    value="{{ isset($rakanTaman[$i+4]) ? $rakanTaman[$i+4]['ajk'.$i.'_nama'] : '' }}">
                            </td>
                            <td style="padding: 4px 8px; line-height: 1;">
                                <input type="text" id="ajk{{ $i }}_tel_bimbit" name="ajk{{ $i }}_tel_bimbit" class="form-control"  
                                    value="{{ isset($rakanTaman[$i+4]) ? $rakanTaman[$i+4]['ajk'.$i.'_tel_bimbit'] : '' }}">
                            </td>
                            <td style="padding: 4px 8px; line-height: 1;">
                                <input type="email" id="ajk{{ $i }}_email" name="ajk{{ $i }}_email" class="form-control lowercase"  
                    ...
                    <!-- <tr>
                        ...
                        <td style="padding: 4px 8px; line-height: 1;"><input type="text" id="penyelaras_nama" name="penyelaras_nama" class="form-control"  value=""></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input type="text" id="penyelaras_tel_bimbit" name="penyelaras_tel_bimbit" class="form-control"  value=""></td>
                        <td style="padding: 4px 8px; line-height: 1;"><input type="email" id="penyelaras_email" name="penyelaras_email" class="form-control lowercase"  value=""></td>
                    </tr> -->
                    ...
                    <tr>
                        ...
                        <td style="padding: 4px 8px; line-height: 1;">
                            <input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="penyelaras_nama" name="penyelaras_nama" class="form-control @error('penyelaras_nama') is-invalid @enderror"  value="{{ isset($rakanTaman) ? $rakanTaman[4]['penyelaras_nama'] : '' }}" >
                        ...
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="penyelaras_tel_bimbit" name="penyelaras_tel_bimbit" class="form-control "  value="{{ isset($rakanTaman) ? $rakanTaman[4]['penyelaras_tel_bimbit'] : '' }}" ></td>
                        <td style="padding: 4px 8px; line-height: 1;">
                            <input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="penyelaras_email" name="penyelaras_email" class="form-control lowercase @error('penyelaras_email') is-invalid @enderror"  value="{{ isset($rakanTaman) ? $rakanTaman[4]['penyelaras_email'] : '' }}">
                    ...
                    <tr>
                        <td style="padding: 4px 8px; line-height: 1;">Wakil PBT <span class="font-red"> * </span></td>
                        <td style="padding: 4px 8px; line-height: 1;">
                            <input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="penyelaras_nama" name="penyelaras_nama" class="form-control @error('penyelaras_nama') is-invalid @enderror"  value="{{ isset($MIB->name) ? $MIB->name : '' }}" >
                            @error('penyelaras_nama')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <td style="padding: 4px 8px; line-height: 1;"><input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="text" id="penyelaras_tel_bimbit" name="penyelaras_tel_bimbit" class="form-control "  value="" ></td>
                        <td style="padding: 4px 8px; line-height: 1;">
                            <input {{ (strpos(request()->url(), 'edit') === false) && (strpos(request()->url(), 'create') === false) ? '' : 'required' }} type="email" id="penyelaras_email" name="penyelaras_email" class="form-control lowercase @error('penyelaras_email') is-invalid @enderror"  value="{{ isset($MIB->email) ? $MIB->email : '' }}">
                            @error('penyelaras_email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
    ...
    $(document).ready(function() {
        ...
        $('#addKawasan').click(function() {
            var newRow = `
                <tr>
                    <td style="vertical-align:middle;">
                        <input type="text" name="kawasan[${rowIndex}][nama]" class="form-control"  value="">
                    </td>
                    <td style="vertical-align:middle;">
                        <input type="text" name="kawasan[${rowIndex}][keluasan]" class="form-control decimal"  value="">
                    </td>
                </tr>
            `;
