...
<div class="form-group col-md-6">
    ...
    {{ Form::text('tarikh', null, ['autocomplete'=>'off','placeholder' => 'Sila Masukkan Tarikh', 'required' => true, 'class' => 'form-control tarikh ' . Html::isInvalid($errors, 'tarikh'), 'id' => 'tarikh']) }}
