    ...
    <div class="row">
        <div class="col-lg col-separator">
            ...
            <div class="form-group required">
                ...
                <div class="col-md-12">
                    <input name="name" class="form-control" maxlength="50" type="text" id="name" >
                    <input name="jenis_industri" class="form-control" value="{{ $capitalizedSegment }}" type="text" id="name" >
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group required col-md-6">
                    ...
                    <div class="col-md-12">
                        <input value="{{isset($ePIL->address1) ? $ePIL->address1 : ''}}" name="address1" class="form-control" maxlength="50" type="text" id="address1" >
                    </div>
                </div>
                ...
                <div class="form-group required col-md-6">
                    ...
                    <div class="col-md-12">
                        <input value="{{isset($ePIL->address2) ? $ePIL->address2 : ''}}" name="address2" class="form-control" maxlength="50" type="text" id="address2">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="form-group required col-md-2">
                    ...
                    <div class="col-md-12">
                        <input value="{{isset($ePIL->postcode) ? $ePIL->postcode : ''}}" name="postcode" class="form-control" type="char" id="postcode" >
                    </div>
                </div>
                ...
                <div class="form-group required col-md-4">
                    ...
                    <div class="col-md-12">
                        <input value="{{isset($ePIL->locality) ? $ePIL->locality : ''}}" name="locality" class="form-control" maxlength="50" type="text" id="locality">
                    </div>
                </div>
                ...
                <div class="form-group required col-md-6">
                    ...
                    <div class="col-md-12">
                        <input value="{{isset($ePIL->state) ? $ePIL->state : ''}}" name="state" class="form-control" type="char" id="state" >
                    </div>
                </div>
            </div>
                    ...
                    $(document).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                var negeriSelected = "{{ isset($ePIL->negeri_penggiat) ? $ePIL->negeri_penggiat : '' }}"; // Assuming you have $ePIL->negeri
                                if (negeriSelected) {
                            ...
                            if (negeriId) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        var daerahSelected = "{{ isset($ePIL->daerah_penggiat) ? $ePIL->daerah_penggiat : '' }}"; // Assuming you have $ePIL->daerah
                                        if (daerahSelected) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        var parlimenSelected = "{{ isset($ePIL->parlimen_penggiat) ? $ePIL->parlimen_penggiat : '' }}"; // Assuming you have $ePIL->parlimen
                                        if (parlimenSelected) {
                            ...
                            if (daerahId && negeriId) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        var mukimSelected = "{{ isset($ePIL->mukim_penggiat) ? $ePIL->mukim_penggiat : '' }}"; // Assuming you have $ePIL->mukim
                                        if (mukimSelected) {
                            ...
                            if (parlimenId) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(data) {
                                        ...
                                        var dunSelected = "{{ isset($ePIL->dun_penggiat) ? $ePIL->dun_penggiat : '' }}"; // Assuming you have $ePIL->dun
                                        if (dunSelected) {
        ...
        <div class="col-lg col-separator">
            ...
            @if($capitalizedSegment == 'Kontraktor' || $capitalizedSegment == 'Perunding' || $capitalizedSegment == 'Pembekal')
                <div class="row">
                    <div class="form-group required col-md-4">
                        ...
                        <div class="col-md-12">
                            <input name="no_ssm" class="form-control" maxlength="50" type="text" id="no_ssm" >
                        </div>
                    </div>
                    ...
                    <div class="form-group required col-md-4">
                        ...
                        <div class="col-md-12">
                            <input name="no_mof" class="form-control" maxlength="50" type="text" id="no_mof" >
                        </div>
                    </div>
                    <div class="form-group required col-md-4">
                        <label for="bilPekerja" class="col-md-12 control-label">Bilangan Pekerja</label>
                        <div class="col-md-12">
                            <input name="bilPekerja" class="form-control" type="number" id="bilPekerja" min="0">
                        </div>
                    </div>
                </div>
                @if($capitalizedSegment == 'Kontraktor')
                    <div class="row">
                        <div class="form-group required col-md-8">
                            ...
                            <div class="col-md-12">
                                <select name="kelas_kontraktor" class="form-control" id="kelas_kontraktor" >
                        ...
                        <div class="form-group required">
                            ...
                            <div class="col-md-12">
                                <input name="no_cidb" class="form-control" maxlength="50" type="text" id="no_cidb" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group required col-md-4">
                            ...
                            <div class="col-md-12">
                                <select name="taraf_bumiputera" class="form-control" id="taraf_bumiputera">
                        ...
                        <div class="form-group required col-md-4">
                            ...
                            <div class="col-md-12">
                                <select name="status_eperunding" class="form-control" id="status_eperunding" >
                                    <option value="0">TIADA MAKLUMAT</option>
                        ...
                        <div class="form-group required col-md-4">
                            ...
                            <div class="col-md-12">
                                <select name="bidang_kepakaran" class="form-control" id="bidang_kepakaran" >
                                    <option value="0">TIADA MAKLUMAT</option>
                                    <option value="1">LANDSKAP ARKITEK</option>
                                    <option value="2">ELEKTRIK</option>
                                    <option value="3">SIVIL DAN STRUKTUR</option>
                                    <option value="4">UKURBAHAN</option>
                ...
                @elseif($capitalizedSegment == 'Perunding')
                    <div class="row">
                        <div class="form-group required col-md-4">
                            ...
                            <div class="col-md-12">
                                <input name="no_ilam" class="form-control" maxlength="50" type="text" id="no_ilam" >
                            </div>
                        </div>
                        ...
                        <div class="form-group required col-md-4">
                            ...
                            <div class="col-md-12">
                                <input name="tarikh_luput_ilam" class="form-control" maxlength="50" type="date" id="tarikh_luput_ilam" >
                            </div>
                        </div>
                        <div class="form-group required col-md-4">
                            <label for="status_eperunding" class="col-md-12 control-label">Status e-Perunding</label>
                ...
                @elseif($capitalizedSegment == 'Pembekal')
                    <div class="row">
                        <div class="form-group required col-md-6">
                            ...
                            <div class="col-md-12">
                                <select name="bidang_pembekal" class="form-control" id="bidang_pembekal"  onchange="handleBidangChange()">
                                    <option value="-1">Pilih Bidang</option>
                                    <option value="1">Nurseri & Landskap Kejur</option>
                                    <option value="2">Alat Permainan</option>
                        ...
                        <div class="form-group required col-md-6" style="display: none;" id="lainLainDiv">
                            ...
                            <div class="col-md-12">
                                <input name="bidang_lain_pembekal" class="form-control" maxlength="50" type="text" id="bidang_lain_pembekal">
                            </div>
                        </div>
                        ...
                        <div class="form-group required col-md-6" style="display: none;" id="nurseriDiv">
                            ...
                            <div class="col-md-12">
                                <select name="saiz_nurseri" class="form-control" id="saiz_nurseri">
                                    <option value="0">TIADA MAKLUMAT</option>
                                    <option value="1">< 2 EKAR</option>
                                    <option value="2">2 - 10 EKAR</option>
                                    <option value="3">> 10 EKAR</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        // Select the dropdown and the Lain-lain textbox
            ...
            @elseif($lastSegment == 'antarabangsa')
                <div class="row">
                    <div class="form-group required col-md-6">
                        ...
                        <div class="col-md-12">
                            <input name="nama_presiden" class="form-control" maxlength="50" type="text" id="nama_presiden" >
                        </div>
                    </div>
                    ...
                    <div class="form-group required col-md-6">
                        ...
                        <div class="col-md-12">
                            <input name="wakil_negara" class="form-control" maxlength="50" type="text" id="wakil_negara" >
                        </div>
                    </div>
                </div>
            @elseif($lastSegment == 'ngo')
                <div class="row">
                    <div class="form-group required col-md-6">
                        ...
                        <div class="col-md-12">
                            <select name="kategori_ngo" class="form-control" id="kategori_ngo" >
                                <option value="">Pilih Kategori</option>
                                <option value="Badan Bukan Kerajaan (NGO)">Badan Bukan Kerajaan (NGO)</option>
                                <option value="Badan Ikhtisas">Badan Ikhtisas</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group required col-md-6">
            ...
            @elseif($lastSegment == 'pendidikan')
                <div class="row">
                    <div class="form-group required col-md-12">
                        ...
                        <div class="col-md-12">
                            <select name="jenis_institusi" class="form-control" id="ContractorJenis Institusi" >
                                <option value="">Pilih Jenis Institusi</option>
                                <option value="IPTA">IPTA</option>
            ...
            <div class="row">
                @php
                    if(isset($ePIL->mediaSosial_penggiat)){
                        $mediaSosial_penggiatData = json_decode($ePIL->mediaSosial_penggiat, true);
    ...
    <div class="col-lg">
        <div class="row col-md-12">
            <div class="col-lg col-separator">
                <div class="form-group">
                    ...
                    <div class="col-xs-12">
                        <h4 class="d-flex align-items-center justify-content-between">
                            Senarai Pekerja
                            <button type="button" class="btn btn-primary btn-sm" id="addPekerja">
                                Tambah Pekerja
                            </button>
                        </h4>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <div class="table-responsive">
                            <table id="pekerja-table" class="table table-bordered table-hover">
                                <thead class="thead-dark">
                                    <style>
                                        #pekerja-table th, #pekerja-table td {
                                            padding: 2px 5px; /* Minimal padding for smaller cells */
                                            text-align: center; /* Center text horizontally */
                                            height: auto; /* Let the height adjust based on content */
                                        }

                                        #pekerja-table td input {
                ...
                <script>
                    $(document).ready(function() {
                        let rowCount = 0;  // Start counting from 0 (no rows)
                        ...
                        function addNewRow() {
                            ...
                            let newRow = `
                                <tr id="row-${rowCount}">
                                    <td>${rowCount}</td>
                                    <td><input type="text" name="pekerja[${rowCount}][nama]" placeholder="Nama" class="form-control"></td>
                                    <td><input type="text" name="pekerja[${rowCount}][jawatan]" placeholder="Jawatan" class="form-control"></td>
                                    <td style="padding: 0; vertical-align: middle; text-align: center;">
                                        <button type="button" class="btn btn-danger btn-sm delete-row" data-row="row-${rowCount}" 
                            ...
                            $('#pekerja_row').hide();  // Hide the "Tiada Maklumat" row if it exists
                            updateBilPekerja();  // Recalculate row numbers after adding a new row
                        }
                        ...
                        // Handle adding new row when the "Tambah Pekerja" button is clicked
                        $('#addPekerja').on('click', function() {
                            addNewRow();
                            let totalRows = isNaN(parseInt($('#bilPekerja').val(), 10)) ? 0 : parseInt($('#bilPekerja').val(), 10);
                            let currentRows = $('#pekerja_container tr').length - 1;
                            if (totalRows < currentRows) {
                                $('#bilPekerja').val(currentRows);
                            }
                        });
                        $('#bilPekerja').on('change', function() {
                            let totalRows = isNaN(parseInt($(this).val(), 10)) ? 0 : parseInt($(this).val(), 10);
                            let currentRows = $('#pekerja_container tr').length - 1;
                            if (totalRows > currentRows) {
                        ...
                        $(document).on('click', '.delete-row', function() {
                            ...
                            $(`#${rowId}`).remove();
                            updateBilPekerja();  // Recalculate row numbers after deletion

                            // If no rows are left, show the pekerja row
            ...
            <div class="col-lg col-separator">
                <div class="form-group">
                    ...
                    <div class="col-xs-12">
                        <h4 class="d-flex align-items-center justify-content-between">
                            Senarai Pengalaman
                            <button type="button" class="btn btn-primary btn-sm" id="addPengalaman">
                                Tambah Pengalaman
                            </button>
                        </h4>
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        <div class="table-responsive">
                            <table id="pengalaman-table" class="table table-bordered table-hover">
                                <thead class="thead-dark">
                                    <style>
                                        #pengalaman-table th, #pengalaman-table td {
                                            padding: 2px 5px; /* Minimal padding for smaller cells */
                                            text-align: center; /* Center text horizontally */
                                            height: auto; /* Let the height adjust based on content */
                                        }

                                        #pengalaman-table td input {
                                            padding: 3px 5px; /* Small padding inside input fields */
                                            height: 25px; /* Small height for input fields */
                                            font-size: 12px; /* Smaller font size for compact input fields */
                                        }
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        function addNewRow() {
                            ...
                            $('#pengalaman_row').hide();  // Hide the "Tiada Maklumat" row if it exists
                            updateBilPengalaman();  // Recalculate row numbers after adding a new row
                        }
            ...
            <div class="row col-md-12">
                <div class="col-lg col-separator">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <div class="table-responsive">
                                <table id="projek-table" class="table table-bordered table-hover">
                                    <thead class="thead-dark">
                                        <style>
                                            #projek-table th, #projek-table td {
                                                padding: 2px 5px; /* Minimal padding for smaller cells */
                                                text-align: center; /* Center text horizontally */
                                                height: auto; /* Let the height adjust based on content */
                                            }

                                            #projek-table td input {
                                                padding: 3px 5px; /* Small padding inside input fields */
                                                height: 25px; /* Small height for input fields */
                                                font-size: 12px; /* Smaller font size for compact input fields */
                                            }
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="gambarModalLabel">Pilih Gambar</h5>
                                ...
                                <div class="modal-body">
                                    <style>
                                        /* Modal Body Style - Centering Content */
                                        .modal-body {
                                            display: flex;
                                            flex-direction: column;
                                            justify-content: center;  /* Vertically center */
                                            align-items: center;      /* Horizontally center */
                                            height: 100%;             /* Full height of the modal body */
                                    ...
                                    <div class="grid-container">
                                        ...
                                        <div class="grid-item">
                                            <input type="file" class="form-control-file" id="gambar_input_modal_1" accept="image/*">
                                            <div id="imagePreviewContainer1" class="image-preview-container"></div>
                                        </div>

                                        <!-- Second Image Preview and File Input -->
                                        <div class="grid-item">
                                            <input type="file" class="form-control-file" id="gambar_input_modal_2" accept="image/*">
                                            <div id="imagePreviewContainer2" class="image-preview-container"></div>
                                        </div>

                                        <!-- Third Image Preview and File Input -->
                                        <div class="grid-item">
                                            <input type="file" class="form-control-file" id="gambar_input_modal_3" accept="image/*">
                                            <div id="imagePreviewContainer3" class="image-preview-container"></div>
                                        </div>

                                        <!-- Fourth Image Preview and File Input -->
                                        <div class="grid-item">
                                            <input type="file" class="form-control-file" id="gambar_input_modal_4" accept="image/*">
                                            <div id="imagePreviewContainer4" class="image-preview-container"></div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-primary" id="addImagesBtn">Tambah Gambar</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                                ...
                                newRow.innerHTML = `
                                    ...
                                    <td>
                                        <div class="grid-container">
                                            ...
                                            <div class="grid-item">
                                                <input type="file" class="form-control-file" id="gambar_produk_1_${bilCount}" name="produk[${bilCount}][gambar_produk_1_${bilCount}]" accept="image/*">
                                                <div id="imagePreviewContainer_1_${bilCount}" class="image-preview-container"></div>
                                            </div>
                                            <div class="grid-item">
                                                <input type="file" class="form-control-file" id="gambar_produk_2_${bilCount}" name="produk[${bilCount}][gambar_produk_2_${bilCount}]" accept="image/*">
                                                <div id="imagePreviewContainer_2_${bilCount}" class="image-preview-container"></div>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm remove_field">Hapus</button>
                                    </td>
                                `;
                            ...
                            // Add images to the current row when "Tambah Gambar" is clicked in the modal
                            // document.getElementById('addImagesBtn').addEventListener('click', function() {
                            //     var images = [];
                            //     for (var i = 1; i <= 4; i++) {
                            //         var gambarInput = document.getElementById('gambar_input_modal_' + i);
                            //         if (gambarInput.files.length > 0) {
                            //             images.push(gambarInput.files[0]);
                            //         }
                            //     }
                            //     console.log(images);
                            //     // if (images.length > 0) {
                            //     //     var readerCount = 0;
                            //     //     var imageFiles = [];
                            //     //                             // Function to handle reading image files
                            //     //     function handleImageReader(reader, imageFile) {
                            ...
                            //     //             reader.readAsDataURL(imageFile);  // Read the selected image as base64
                            //     //         });
                            //     //     }

                            //     //     // Function to process all images in order
                            //     //     async function processImages() {
                            //     //         for (const imageFile of images) {
                            //     //             var reader = new FileReader();
                            //     //             await handleImageReader(reader, imageFile);  // Wait for each image to load before proceeding
                            //     //         }

                            //     //         // After all images are loaded, display them in the table
                            //     //         var imageCell = currentRow.querySelector('td:nth-child(5)');
                                        
                            //     //         let testImage = '';
                            //     //         for (var k = 0; k < readerCount; k++) {
                            //     //             testImage += `<img src="${imageFiles[k]}" alt="${k}" style="width: 50px; height: 50px; object-fit: cover; margin: 2px;">`;
                            //     //         }
                                        
                            //     //         var imageHtml = testImage;
                            //     //         var buttonHtml = `
                            //     //             <button type="button" class="btn btn-info btn-sm image-button">Pilih Gambar</button>
                            //     //             <textarea class="gambar_hidden" name="gambar[]" style="display: none;">${imageFiles.join(',')}</textarea>
                            //     //         `;
                            //     //         imageCell.innerHTML = imageHtml + buttonHtml;

                            //     //         $('#gambarModal').modal('hide'); // Close the modal after adding images
                            //     //     }
