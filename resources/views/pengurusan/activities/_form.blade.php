...
<script>
    ...
    var selectdate1 = '{{ isset($activity->start_at) ? $activity->start_at->format('Y-m-d') : null }}';
    var selectdate2 = '{{ isset($activity->end_at) ? $activity->end_at->format('Y-m-d') : null }}';
    ...
    $.validator.addMethod('filesize', function(value, element, param) {
        ...
        $('#modalFormAktiviti').validate({ //sets up the validator
...
@include('pengurusan.activities._zon')

@include('pengurusan.activities._slot')
        ...
        <table id="example" class="responsive table table-bordered table-sm">
            ...
            <tr>
                <td>
                    ...
                    <div class="form-group">
                        {{ Form::label('file', 'JadualProgram/Aktiviti') }}
                        <div class="custom-file">
