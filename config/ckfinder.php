...
$config['backends']['default'] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      =>  env('APP_URL') . 'storage', // env('APP_URL') . '/userfiles/'
    'root'         => storage_path('app/public'), //'public_path('/userfiles/')
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
