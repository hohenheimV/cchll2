...
@section('title', 'Tagging '.$first.' - '.$last)
    ...
    <div class="card">
        <div class="main">
            <div class="section-one">
                <div class="qrcode">
                    <img
                        src="data:image/png;base64, {!! base64_encode(QrCode::format('png')->merge(asset('img/logo-jln-qr.png'), .4, true)->margin(0)->size(100)->errorCorrection('H')->generate($item->softscape_qrcode)) !!} ">
                </div>
                <p>{{$item->kod_tag}}</p>
            </div>
