        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card card-olive card-outline ">
                    ...
                    {{ Form::open(['route' => ['pengurusan.drone.store'], 'enctype' => 'multipart/form-data', 'id' => 'droneForm']) }}
                    <div class="card-body table-hardscape form-hardscape text-sm">

                        @include('pengurusan.drone._form')

                        @include('pengurusan.drone._upload')
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#droneForm').ajaxForm({
                ...
                complete: function(xhr) {
                    ...
                    window.location.replace("{{ route('pengurusan.drone.index') }}");
                }
            });
