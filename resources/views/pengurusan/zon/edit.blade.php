...
@section('title', 'Kemaskini Maklumat Zon')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-olive card-outline ">
                ...
                {!! Form::model($zon, ['route' => ['pengurusan.zon.update', $zon], 'method'=>'PUT','enctype'=>'multipart/form-data', 'id'=>'zonForm']) !!}
                ...
                <div class="card-footer">
                    {!! Form::button('Batal dan Kembali', ['onclick'=>"window.location='".route('pengurusan.zon.index')."'",'class'=>'btn btn-secondary']) !!}
        ...
        $(document).ready(function() {
            ...
            $('#zonForm').ajaxForm({
                ...
                complete: function(xhr) {
                    ...
                    window.location.replace("{{ route('pengurusan.zon.index') }}");
                }
            });
