                ...
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <form class="form-inline" action="{{ route('pengurusan.audits.logged') }}" method="get" novalidate>
                                ...
                                <div class="input-group mr-2">
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <button type="button" class="btn btn-secondary btn-sm" onclick="window.location.href='{{route('pengurusan.audits.logged')}}'">Reset</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <table id="example" class="responsive table table-bordered table-hover table-fixed table-striped table-sm mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{!! $audit->created_at ? $audit->created_at->format('d-m-Y H:i A') : '-' !!}</td>
                            </tr>
                            @empty
                            <p>{{request('keyword')}}</p>
                            @endforelse
